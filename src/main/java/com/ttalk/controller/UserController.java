package com.ttalk.controller;

import com.ttalk.enums.OperatorFriendRequestTypeEnum;
import com.ttalk.enums.SearchFriendsStatusEnum;
import com.ttalk.pojo.Users;
import com.ttalk.pojo.bo.UsersBO;
import com.ttalk.pojo.vo.MyFriendsVO;
import com.ttalk.pojo.vo.UsersVO;
import com.ttalk.service.UserService;
import com.ttalk.utils.FastDFSClient;
import com.ttalk.utils.FileUtils;
import com.ttalk.utils.IMoocJSONResult;
import com.ttalk.utils.MD5Utils;
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
	...
	public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
		...
		// 查询列表
		List<com.ttalk.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
